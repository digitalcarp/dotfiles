---@class minisnacks.bufdelete
---@overload fun(buf?: number|minisnacks.bufdelete.Opts)
...
---@class minisnacks.bufdelete.Opts
...
--- Delete all buffers
---@param opts? minisnacks.bufdelete.Opts
function M.all(opts)
